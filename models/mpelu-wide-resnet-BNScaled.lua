   ...
   local function wide_basic(nInputPlane, nOutputPlane, stride)
      ...
      for i,v in ipairs(conv_params) do
         if i == 1 then  -- in which case, v == {3,3,stride,stride,1,1}
            ...
            module:add(SBatchNorm(nInputPlane)):add(MPELU(alpha, beta, 5, 5, 5, 5, nInputPlane))
            ...
            convs:add(SBatchNorm(nBottleneckPlane)):add(MPELU(alpha, beta, 5, 5, 5, 5, nBottleneckPlane))
